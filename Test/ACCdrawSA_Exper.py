...
plt.plot(x1,y1,label='ACC', marker='*', ms=5, alpha=0.7)
plt.plot(x1,y2,label='SPEC', marker='*', ms=5, alpha=0.7)
plt.plot(x1,y3,label='AUC', marker='*', ms=5, alpha=0.7)
plt.plot(x1,y4,label='Sen', marker='*', ms=5, alpha=0.7)
